---
title: "Making an interactive cemetery map from scratch, for reasons"
date: "06/12/2025"
tags: ["webdesign"]
...
Having done exactly 01 static website in my life I originally declined as I felt I wasn't up to the task but their current website was such a broken wordpress mess that I decided to give it a shot.

[Link to the website]()

[Link to the super cool interactive map that you need to see for yourself and I guess there is also a neat table at the]()
...
The most interesting part must be adding arab support, I had to re-write most of my css since its right to left nature broke a lot of stuff (including my [map]()). 
...
I dont know how to end this post, so here is a weird commit out of context from when I was cross-referencing different tables and documents to validate the tombs data
