...
My new rule of thumb is simple, be sure you are using pruners to the best of their capability by reporting intermediary performance of models and pick the new [Optuna Autosampler]() to get a great step up from the default with little to no extra work.
